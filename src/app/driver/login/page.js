        ...
        <div className="min-h-screen bg-slate-100 flex items-center justify-center p-4">
            <div className="bg-white w-full max-w-md rounded-2xl shadow-xl overflow-hidden">
                <div className="bg-slate-950 p-8 text-center">
                    <div className="w-20 h-20 bg-amber-800 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
                ...
                <div className="p-8">
                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-12 pr-4 py-3 rounded-xl border border-gray-200 focus:border-amber-600 focus:ring-2 focus:ring-amber-600/20 outline-none transition-all font-bold text-gray-800"
                                    value={phone}
                        ...
                        <button
                            ...
                            className="w-full bg-slate-950 text-white py-4 rounded-xl font-bold text-lg hover:bg-amber-800 active:scale-[0.98] transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                    ...
                    <div className="mt-8 text-center border-t border-gray-100 pt-6">
                        ...
                        <button
                            ...
                            className="text-amber-700 font-bold hover:text-slate-950 hover:underline transition-colors"
                        >
