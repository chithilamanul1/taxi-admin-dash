        ...
        <main className="min-h-screen bg-gradient-to-b from-slate-950 to-slate-950 pt-32 pb-20">
            <div className="container mx-auto px-6">
                    ...
                    <div className="p-8 md:p-12 space-y-10">
                        ...
                        <section>
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h2 className="text-2xl font-bold text-slate-950">Customer Registration</h2>
                            </div>
                        ...
                        <section>
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h2 className="text-2xl font-bold text-slate-950">Booking & Payment</h2>
                            </div>
                            <div className="pl-13 space-y-3 text-slate-600 leading-relaxed">
                        ...
                        <section>
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h2 className="text-2xl font-bold text-slate-950">Service Delivery (Transport / Pickup)</h2>
                            </div>
                            <div className="pl-13 space-y-3 text-slate-600 leading-relaxed">
                        ...
                        <section>
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h2 className="text-2xl font-bold text-slate-950">Cancellation & Refunds</h2>
                            </div>
                                ...
                                <div className="overflow-x-auto">
                                    <table className="w-full border border-slate-200 rounded-xl overflow-hidden">
                                        <thead className="bg-amber-50">
                                            <tr>
                                                <th className="px-4 py-3 text-left text-slate-950 font-bold">Condition</th>
                                                <th className="px-4 py-3 text-left text-slate-950 font-bold">Refund Eligibility</th>
                                            </tr>
                                        </thead>
                        ...
                        <section>
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h2 className="text-2xl font-bold text-slate-950">Fraud Prevention & Verification</h2>
                            </div>
                            <div className="pl-13 space-y-3 text-slate-600 leading-relaxed">
                                <ul className="list-disc pl-6 space-y-2">
                        ...
                        <section>
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h2 className="text-2xl font-bold text-slate-950">Communication & Records</h2>
                            </div>
                            <div className="pl-13 space-y-3 text-slate-600 leading-relaxed">
                        ...
                        <section>
                            <div className="flex items-center gap-3 mb-4">
                                <div className="w-10 h-10 bg-amber-100 rounded-xl flex items-center justify-center">
                                    <span className="text-amber-700 font-black">7</span>
                                </div>
                                <h2 className="text-2xl font-bold text-slate-950">Policy Display & Payment Links</h2>
                            </div>
                            <div className="pl-13 space-y-3 text-slate-600 leading-relaxed">
                        ...
                        <section>
                            <div className="flex items-center gap-3 mb-4">
                                <div className="w-10 h-10 bg-amber-100 rounded-xl flex items-center justify-center">
                                    <span className="text-amber-700 font-black">8</span>
                                </div>
                                <h2 className="text-2xl font-bold text-slate-950">Overseas & Special Transactions</h2>
                            </div>
                            <div className="pl-13 space-y-3 text-slate-600 leading-relaxed">
                                <ul className="list-disc pl-6 space-y-2">
                        ...
                        <section>
                            <div className="flex items-center gap-3 mb-4">
                                <div className="w-10 h-10 bg-amber-100 rounded-xl flex items-center justify-center">
                                    <span className="text-amber-700 font-black">9</span>
                                </div>
                                <h2 className="text-2xl font-bold text-slate-950">Legal Compliance</h2>
                            </div>
                            <div className="pl-13 space-y-3 text-slate-600 leading-relaxed">
                        ...
                        <section>
                            <div className="flex items-center gap-3 mb-4">
                                <div className="w-10 h-10 bg-amber-100 rounded-xl flex items-center justify-center">
                                    <span className="text-amber-700 font-black">10</span>
                                </div>
                        ...
                        <section>
                            <div className="flex items-center gap-3 mb-4">
                                <div className="w-10 h-10 bg-amber-100 rounded-xl flex items-center justify-center">
                                    <span className="text-amber-700 font-black">12</span>
                                </div>
                                <h2 className="text-2xl font-bold text-slate-950">Contact</h2>
                            </div>
                            <div className="bg-amber-50 rounded-2xl p-6 mt-4">
                                <h3 className="font-bold text-slate-950 text-lg mb-2">AIRPORT TAXIS PVT (LTD)</h3>
                                <p className="text-sm text-amber-700 mb-4">Reg. No: PV 00342552</p>
                                <div className="space-y-3">
                                    ...
                                    <div className="flex items-center gap-3 text-slate-600">
                                        ...
                                        <a href="mailto:info@airporttaxis.lk" className="hover:text-amber-600">info@airporttaxis.lk</a>
                                    </div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section className="border-t border-slate-200 pt-8">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h2 className="text-2xl font-bold text-slate-950">Agreement</h2>
                            </div>
                ...
                <div className="text-center mt-12">
                    <Link href="/" className="inline-flex items-center gap-2 px-8 py-4 bg-white text-slate-950 rounded-2xl font-bold shadow-lg hover:bg-amber-50 transition-all">
                        ← Back to Home
                    </Link>
                </div>
            </div>
