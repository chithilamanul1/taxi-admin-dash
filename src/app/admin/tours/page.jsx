...
export default function ToursAdmin() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-emerald-900 p-6 md:p-10">
            <div className="max-w-7xl mx-auto">
                <div className="flex items-center justify-between mb-8">
                    <div>
                        ...
                        <h1 className="text-3xl font-black text-emerald-900 dark:text-white">Tour Packages</h1>
                ...
                {loading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {tours.map(tour => (
                            <div key={tour._id} className="bg-white dark:bg-emerald-900 rounded-2xl p-4 shadow-sm border border-slate-200 dark:border-slate-800 hover:shadow-md transition-shadow group relative">
                                <div className="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity bg-white/90 dark:bg-emerald-900/90 p-1.5 rounded-lg backdrop-blur-sm shadow-sm z-10">
                                ...
                                <h3 className="font-bold text-emerald-900 dark:text-white mb-1 line-clamp-1">{tour.title}</h3>
                ...
                {showModal && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
                        <div className="bg-white dark:bg-emerald-900 w-full max-w-2xl rounded-2xl shadow-2xl overflow-hidden max-h-[90vh] flex flex-col">
                            <div className="p-6 border-b border-slate-200 dark:border-slate-800 flex justify-between items-center bg-slate-50 dark:bg-emerald-900">
