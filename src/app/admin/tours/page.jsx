        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 p-6 md:p-10">
            <div className="max-w-7xl mx-auto">
                <div className="flex items-center justify-between mb-8">
                    <div>
                        <Link href="/admin" className="flex items-center gap-2 text-slate-500 hover:text-slate-600 mb-2 transition-colors">
                    ...
                    <button
                        ...
                        className="bg-slate-600 text-white px-6 py-3 rounded-xl font-bold flex items-center gap-2 hover:bg-slate-700 transition-colors shadow-lg shadow-slate-600/20"
                    >
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
                        <div className="bg-white dark:bg-slate-900 w-full max-w-2xl rounded-2xl shadow-2xl overflow-hidden max-h-[90vh] flex flex-col">
                            ...
                            <form onSubmit={handleSubmit} className="p-6 overflow-y-auto space-y-4 text-sm">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-1">
                                        <label className="font-bold text-slate-600">Inclusions (comma separated)</label>
                                        <textarea rows="2" className="w-full p-3 rounded-xl border bg-slate-50 dark:bg-slate-900/10 border-amber-200 dark:border-slate-800 outline-none focus:ring-2 focus:ring-amber-500 dark:text-white"
                                ...
                                <button type="submit" disabled={uploading} className="w-full bg-slate-600 text-white font-bold py-4 rounded-xl hover:bg-slate-700 transition-colors shadow-lg shadow-slate-600/20 mt-4 disabled:opacity-50 flex items-center justify-center gap-2">
