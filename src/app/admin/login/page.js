...
function LoginForm() {
    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-[#0a0f18] p-4 font-['Inter',sans-serif]">
            <div className="w-full max-w-md bg-white dark:bg-emerald-900 rounded-[2rem] border border-emerald-900/10 dark:border-white/5 shadow-2xl overflow-hidden">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="relative py-4">
                            ...
                            <div className="relative flex justify-center text-xs uppercase">
                                <span className="bg-white dark:bg-emerald-900 px-4 text-slate-400 font-bold tracking-widest">OR CONTINUE WITH</span>
                            </div>
                        </div>
