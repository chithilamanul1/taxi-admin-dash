                    ...
                    <div className="p-8 md:p-12 space-y-10">
                        ...
                        <section>
                            ...
                            <div className="space-y-3 text-slate-600 leading-relaxed">
                                ...
                                <p>To exercise these rights, contact us at <a href="mailto:info@airporttaxi.lk" className="text-slate-600 hover:underline">info@airporttaxi.lk</a></p>
                            </div>
                        </section>
                        ...
                        <section>
                            <div className="flex items-center gap-3 mb-4">
                                <div className="w-10 h-10 bg-slate-100 rounded-xl flex items-center justify-center">
                                    <span className="text-slate-700 font-black">6</span>
                                </div>
                        ...
                        <section className="bg-slate-50 rounded-2xl p-6">
                            <h3 className="font-bold text-slate-900 text-lg mb-4">Contact Us About Privacy</h3>
                            <div className="space-y-3">
                                <div className="flex items-center gap-3 text-slate-600">
                                    <Mail size={18} className="text-slate-600" />
                                    <a href="mailto:info@airporttaxi.lk" className="hover:text-slate-600">info@airporttaxi.lk</a>
                                </div>
                                <div className="flex items-center gap-3 text-slate-600">
