        ...
        <main className="min-h-screen bg-slate-50">
            ...
            <div className="pt-32 pb-16 bg-slate-950 relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10 text-center text-white">
                    ...
                    <p className="text-lg text-amber-100/80 max-w-2xl mx-auto font-medium">
            ...
            <div className="container mx-auto px-4 py-16">
                {loading ? (
                            ...
                            <div key={coupon._id} className="bg-white rounded-[2.5rem] border border-slate-200 overflow-hidden shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group relative">
                                ...
                                <div className="p-8">
                                    <div className="flex items-center gap-4 mb-8">
                                        <div className="w-16 h-16 bg-amber-50 rounded-[1.5rem] flex items-center justify-center text-amber-600 border border-amber-100 group-hover:scale-110 group-hover:bg-amber-600 group-hover:text-white transition-all duration-500 shadow-inner">
                                            <Tag size={32} />
                                        </div>
                                        <div>
                                    ...
                                    <div className="bg-slate-50 border-2 border-dashed border-slate-200 rounded-[2rem] p-6 mb-8 relative group/code overflow-hidden">
                                        <div className="absolute inset-0 bg-amber-600 translate-y-full group-hover/code:translate-y-0 transition-transform duration-500 ease-out"></div>
                                    ...
                                    <div className="pt-6 border-t border-slate-100 flex items-center justify-between">
                                        ...
                                        <Link
                                            href="/"
                                            className="flex items-center gap-2 text-[10px] font-black text-amber-600 uppercase tracking-widest hover:gap-3 transition-all"
                                        >
                    ...
                    <div className="text-center py-20 bg-white rounded-[3rem] border border-dashed border-slate-300">
                        ...
                        <Link href="/" className="inline-flex mt-6 font-bold text-amber-600 hover:underline">Return to Booking Widget</Link>
                    </div>
                )}

                {/* Info Section */}
                <div className="mt-24 grid md:grid-cols-3 gap-8 text-center bg-slate-950/5 p-12 rounded-[3rem] border border-slate-950/10">
                    <div className="space-y-3">
                        <div className="w-12 h-12 bg-white rounded-xl shadow-sm flex items-center justify-center mx-auto text-amber-600">
                            <Users size={24} />
                        </div>
