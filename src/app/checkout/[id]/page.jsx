        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-slate-50">
                <div className="text-center space-y-4">
                    <Loader2 className="animate-spin text-slate-600 mx-auto" size={48} />
            ...
            {product.isBookingInvoice ? (
                <div className="relative z-10 w-full max-w-lg mx-auto animate-fade-in">
                    <div className="text-center mb-10">
                        ...
                        <h1 className="text-4xl font-black text-slate-900 uppercase">Secure Payment</h1>
                    ...
                    <div className="bg-white rounded-[2.5rem] p-8 shadow-2xl border border-slate-100 flex flex-col items-center">
                        <div className="w-20 h-20 bg-slate-50 text-slate-600 rounded-3xl flex items-center justify-center mb-6">
                            <CreditCard size={40} />
                        </div>
                        ...
                        <div className="bg-slate-50 w-full rounded-2xl p-6 flex flex-col items-center mb-8 border border-slate-100">
                            ...
                            {product.allowedPaymentMode === 'partial' && (
                                <span className="mt-2 text-xs font-bold text-slate-600 bg-slate-50 px-3 py-1 rounded-full border border-slate-100 uppercase tracking-widest">
                        ...
                        <button
                            ...
                            className="w-full py-5 bg-slate-900 hover:bg-slate-800 text-white font-black text-xl rounded-2xl flex items-center justify-center gap-3 transition-all disabled:opacity-70 shadow-xl shadow-slate-900/20"
                        >
                ...
                <>
                    <div className="relative z-10 text-center space-y-8 animate-fade-in">
                        ...
                        <div className="space-y-2">
                            <h1 className="text-3xl md:text-5xl font-black text-slate-900 uppercase">Secure Payment</h1>
