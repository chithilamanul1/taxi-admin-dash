            ...
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    <Link href="/" className="inline-block">
                        <h1 className="text-3xl font-bold text-white">Airport <span className="text-amber-600">Taxis</span></h1>
                ...
                <div className="bg-white rounded-2xl shadow-2xl p-8">
                    <h2 className="text-2xl font-bold text-slate-950 text-center mb-2">Welcome Back</h2>
                    ...
                    <Link
                        href="/prices"
                        className="block w-full text-center bg-amber-600 text-slate-950 px-6 py-4 rounded-xl font-bold hover:bg-yellow-400 transition-colors"
                    >
                        Continue as Guest
                    </Link>
