...
export default function ReviewPage() {
    ...
    if (loading) {
        return (
            <main className="min-h-screen bg-gradient-to-b from-slate-950 to-slate-950 pt-32 pb-20 flex items-center justify-center">
            ...
            <main className="min-h-screen bg-gradient-to-b from-slate-950 to-slate-950 pt-32 pb-20">
                <div className="container mx-auto px-6">
                    <div className="max-w-md mx-auto text-center">
                        ...
                        <button
                            onClick={() => router.push('/')}
                            className="px-8 py-4 bg-white text-slate-950 rounded-2xl font-bold"
                        >
                            Back to Home
                        </button>
                    </div>
                ...
                <div className="max-w-2xl mx-auto">
                    ...
                    <div className="bg-white rounded-3xl p-8 shadow-xl">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            {/* Star Rating */}
                            <div>
                                <label className="block text-sm font-bold text-slate-950 mb-3">
                            ...
                            <button
                                type="submit"
                                disabled={submitting}
                                className="w-full flex items-center justify-center gap-2 px-6 py-4 bg-slate-950 text-white rounded-2xl font-bold hover:bg-amber-800 transition-colors disabled:opacity-50"
                            >
                                {submitting ? (
