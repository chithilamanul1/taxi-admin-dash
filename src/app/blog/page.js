...
export default async function BlogPage() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-emerald-900 pb-20 transition-colors">
            {/* Hero Section */}
            ...
            <div className="container mx-auto px-4 -mt-10 relative z-10">
                {posts.length === 0 ? (
                    <div className="bg-white dark:bg-emerald-900 p-12 rounded-xl shadow-sm text-center border border-emerald-900/10 dark:border-white/5">
