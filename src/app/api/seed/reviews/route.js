...
const reviews = [
    ...
    { name: "Dinesh Krishnabalan", text: "It's very good service onetime pickup and drop It's fabulous Airport cab service. and taxi driver safely ,friendly so I recommend to everyone try this service price also reasonable" },
    { name: "Nissanka Dissanayake", text: "This AirportCab service is highly recommended as truly worthy for the money the service they offer. Mr Chamara runs this service with his team of friendly drivers. They are reliable, easy to contact even at late night and punctual on time. Thanks for the excellent service." },
    ...
    { name: "Praween Rupasinghe", text: "I had a best experience with Airport Cab crew with in last few days. They provided us better service with reasonable rates. And also drivers are so friendly and vehicles also super clean. Im highly recommend their service to everyone who looking for the safe journey." },
    ...
    { name: "Thusitha Athapaththu Mudiyanselage", text: "1st time used Airport cabs when I came to SL this time. Impressive service for a very reasonable price. It was easy to book online and the efficient customer service through Whatsapp was amazing." },
    ...
    { name: "Janaka Wimalachandra", text: "Airport Cab .lk have provided very good cars and excellent drivers for my trips out of Colombo. The cars are sent on time, the interior is very clean, and the driving is very good. The drivers are polite, pleasant men who do their job with great responsibility.. We wish you well" },
    ...
    { name: "Ibrahim Nawasdeen", text: "Very Very nice service and professional driver's with airport cable.lk all ways my chosen well done keep it up" },
    ...
    { name: "madushanka priyadarshana", text: "✈️Would Recommend Taxi Service!!✈️ Airportcab.lk Great Taxi Company! Used them for 5 trips my travel in katunayake airport.i have nothing negative to say. Good coordination💯, Quick resposes💯," },
    ...
    { name: "madushanka Mannage Don", text: "I am very glad to say.Airport cab .lk is the best transportation as well as safely and highly recommended especially thanks Mr Tharindu." },
    ...
    { name: "Ashitha Ashitha", text: "I really appreciate your taxi service and help...specially help me to deliver 55 inches TV to my home without any damage.They are the best in delivering any electronic household items islandwide.I highly recommend AirportCab.lk taxiservice." },
    ...
    { name: "Chathura Madusanka", text: "ඔයාලට airport එකේ ඉදලා ගෙදර යන්න Taxi එකක් book කර ගන්න ඔින නමි මං recommend කරනවා airport cab.lk taxi savece එක විශ්වාසයෙන් යුතුව තෝර ගන්න කියලා මොකද ්එයාලගේ saevice එක supire.ඒ වගේම එයාලගේ රියදුරැ මහත්තුරුත් හරි ම හොදයි.අනිත් විශේම දේ එයාලගේ change එක හරිම සාධාරනයි.thanku airport cab.lk...❤❤❤❤❤❤" },
    ...
    { name: "Buddhika kularathna", text: "We completed the first trip with AirportCab.lk. From Airpirt to Kottawa. They offered an excellent service. I recommend for others. 👏" },
