...
export default function SupportPage() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-emerald-900 pt-24 pb-12 px-4 transition-colors">
            <div className="max-w-4xl mx-auto">
                ...
                {view === 'list' && (
                    <div className="bg-white dark:bg-emerald-900 rounded-2xl shadow-sm overflow-hidden border border-emerald-900/10 dark:border-white/5">
                        {tickets.length === 0 ? (
                ...
                {view === 'new' && (
                    <div className="bg-white dark:bg-emerald-900 rounded-2xl shadow-sm p-8 max-w-2xl mx-auto border border-emerald-900/10 dark:border-white/5">
                ...
                {view === 'detail' && selectedTicket && (
                    <div className="max-w-3xl mx-auto">
                        <div className="bg-white dark:bg-emerald-900 rounded-t-2xl shadow-sm p-6 border-b border-slate-100 dark:border-white/5 flex justify-between items-start">
                            <div>
                        ...
                        <div className="bg-slate-50 dark:bg-emerald-900 p-6 space-y-6 min-h-[400px] max-h-[600px] overflow-y-auto">
                        ...
                        <div className="bg-white dark:bg-emerald-900 rounded-b-2xl shadow-sm p-4 border-t border-slate-100 dark:border-white/5">
