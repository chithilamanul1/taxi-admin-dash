            ...
            <div className="container mx-auto px-6">
                ...
                <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden">
                    ...
                    <div className="p-8 md:p-12 space-y-10">
                        ...
                        {/* How to Cancel */}
                        <section>
                            <h2 className="text-2xl font-bold text-slate-900 mb-4">How to Request a Cancellation</h2>
                            <div className="bg-slate-50 rounded-2xl p-6">
                                <ol className="space-y-4">
                                    <li className="flex gap-4">
                                        <span className="w-8 h-8 bg-slate-600 text-white rounded-full flex items-center justify-center font-bold shrink-0">1</span>
                                        <div>
                                            <p className="font-bold text-slate-900">Contact Us</p>
                                            <p className="text-slate-600">Email us at <a href="mailto:info@airporttaxis.lk" className="text-slate-600">info@airporttaxis.lk</a> or call <a href="tel:+94722885885" className="text-slate-600">+94 722 885 885</a></p>
                                        </div>
                                    </li>
                                    <li className="flex gap-4">
                                        <span className="w-8 h-8 bg-slate-600 text-white rounded-full flex items-center justify-center font-bold shrink-0">2</span>
                                        <div>
                                    ...
                                    <li className="flex gap-4">
                                        <span className="w-8 h-8 bg-slate-600 text-white rounded-full flex items-center justify-center font-bold shrink-0">3</span>
                                        <div>
                        ...
                        {/* Non-Refundable */}
                        <section>
                            <h2 className="text-2xl font-bold text-slate-900 mb-4">Non-Refundable Situations</h2>
                        ...
                        <section className="bg-slate-50 rounded-2xl p-6">
                            <h3 className="font-bold text-slate-900 text-lg mb-4">Need Help with a Refund?</h3>
                            <div className="space-y-4">
                                <div className="flex flex-col gap-1">
                                    <p className="text-sm text-slate-500 font-medium">
                                        Official Refund Policy of Airport Taxis Pvt (Ltd). Last updated January 2024.
                                    </p>
                                    <a href="mailto:info@airporttaxis.lk" className="flex items-center gap-2 text-slate-600 font-bold hover:underline">
                                        <Mail size={16} /> info@airporttaxis.lk
                                    </a>
                                </div>
                                <div className="flex items-center gap-3 text-slate-600">
                                    <Phone size={18} className="text-slate-600" />
                                    <a href="tel:+94722885885" className="hover:text-slate-600 font-medium">+94 722 885 885</a>
                                </div>
                ...
                <div className="max-w-4xl mx-auto mt-8 flex flex-wrap justify-center gap-4">
                    ...
                    <Link href="/" className="px-6 py-3 bg-white text-slate-900 rounded-xl font-bold hover:bg-slate-50 transition-colors">
                        ← Back to Home
                    </Link>
                </div>
            </div>
