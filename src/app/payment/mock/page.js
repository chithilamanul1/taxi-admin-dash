                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-3 border rounded-lg focus:ring-2 focus:ring-amber-600/20 focus:border-amber-600"
                            />
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input
                                type="text"
                                placeholder="MM/YY"
                                className="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-amber-600/20"
                            />
                        </div>
                        <div>
