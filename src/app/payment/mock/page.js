...
function MockPaymentContent() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-emerald-900 to-slate-800 flex items-center justify-center p-4">
...
export default function MockPaymentPage() {
    return (
        <Suspense fallback={<div className="min-h-screen bg-emerald-900 flex items-center justify-center p-4">
