        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-slate-50">
                <div className="bg-white p-8 rounded-2xl shadow-xl border border-red-100 max-w-md text-center">
                    ...
                    <Link href="/" className="text-sm font-bold text-slate-900 hover:underline">Return to Home</Link>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-emerald-950 text-white relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center">
                <div className="w-24 h-24 rounded-full bg-slate-900/50 border border-amber-500/20 flex items-center justify-center mb-8 relative">
                ...
                <div className="flex items-center gap-3 bg-slate-900/50 px-6 py-3 rounded-xl border border-amber-500/10 backdrop-blur-sm">
