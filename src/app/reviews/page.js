        ...
        <main className="min-h-screen bg-slate-50 dark:bg-slate-950">
            ...
            <div className="pt-32 pb-16 bg-slate-900 relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10 text-center text-white">
                    ...
                    <p className="text-lg text-slate-100/80 max-w-2xl mx-auto">
            ...
            <div className="container mx-auto px-4 py-16 space-y-20">
                ...
                {loading ? (
                    ...
                    <>
                        ...
                        {googleData?.reviews?.length > 0 && (
                            <section>
                                <div className="flex items-center gap-4 mb-8 border-b border-slate-900/10 dark:border-white/10 pb-4">
                                    ...
                                    <div>
                                        <h2 className="text-2xl font-bold text-slate-900 dark:text-white">Google Reviews</h2>
                                        <div className="flex items-center gap-2 text-sm text-slate-500">
                                            <span className="font-bold text-slate-600">{googleData.rating} Rating</span>
                                            <span>•</span>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    {googleData.reviews.map((review, i) => (
                                        <div key={i} className="bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-900/5 dark:border-white/5 shadow-sm hover:shadow-xl transition-all duration-300 group">
                                            <div className="flex justify-between items-start mb-6">
                                                <div className="flex items-center gap-3">
                                                    <div className="w-12 h-12 rounded-full overflow-hidden bg-slate-100 dark:bg-slate-900/30 flex items-center justify-center border border-amber-200 dark:border-slate-800 relative">
                                                        {review.profile_photo_url ? (
                                                            ...
                                                            <User className="text-slate-600 dark:text-amber-400" size={20} />
                                                        )}
                                                    </div>
                                                    <div>
                                                ...
                                                <Quote className="text-slate-900/10 dark:text-white/10 group-hover:text-slate-600/20 transition-colors" size={40} />
                                            </div>
                        ...
                        {tripAdvisorData?.reviews?.length > 0 && (
                            <section>
                                <div className="flex items-center gap-4 mb-8 border-b border-slate-900/10 dark:border-white/10 pb-4">
                                    ...
                                    <div>
                                        <h2 className="text-2xl font-bold text-slate-900 dark:text-white">TripAdvisor Reviews</h2>
                                        <div className="flex items-center gap-2 text-sm text-slate-500">
                ...
                <div className="mt-20 text-center">
                    <a
                        ...
                        target="_blank"
                        className="inline-flex items-center gap-2 px-8 py-4 bg-white dark:bg-slate-800 rounded-2xl font-bold text-slate-900 dark:text-white shadow-lg hover:-translate-y-1 transition-transform border border-slate-900/10"
                    >
