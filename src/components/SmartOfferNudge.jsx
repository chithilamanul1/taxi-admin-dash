...
const SmartOfferNudge = ({ offer, onClose }) => {
    ...
    return (
        <div className="fixed bottom-2 right-2 md:bottom-4 md:right-4 z-[60] animate-slide-up-fade max-w-[calc(100vw-24px)] group/nudge">
            <div className="relative bg-gradient-to-br from-amber-500 via-orange-500 to-orange-600 p-[1px] rounded-[2rem] shadow-[0_25px_60px_-15px_rgba(245,158,11,0.3)]">
                <div className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl rounded-[1.95rem] p-5 flex items-start gap-4 relative overflow-hidden">
                    ...
                    <div className="relative">
                        <div className="bg-gradient-to-tr from-amber-100 to-orange-50 dark:from-amber-900/40 dark:to-orange-800/20 p-3 rounded-2xl text-amber-600 dark:text-amber-400 shrink-0 shadow-[inset_0_2px_4px_rgba(0,0,0,0.05)] border border-amber-500/10">
                    ...
                    <div className="flex-1 pr-6">
                        ...
                        <h4 className="font-black text-slate-900 dark:text-white leading-tight mb-1 text-base md:text-lg tracking-tight">
                            {offer.name} <span className="text-amber-600 font-extrabold ml-1">Applied!</span>
                        </h4>
                        ...
                        <div className="flex items-center gap-2">
                            <div className="px-3 py-1 bg-amber-50 dark:bg-amber-500/10 rounded-lg border border-amber-100 dark:border-amber-500/20">
                    ...
                    <div className="absolute bottom-0 left-0 h-[2.5px] bg-gradient-to-r from-amber-500 to-orange-400 w-full origin-left animate-timer-progress opacity-60"></div>
                </div>
            </div>
        </div>
    );
