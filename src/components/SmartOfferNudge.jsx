...
const SmartOfferNudge = ({ offer, onClose }) => {
    ...
    return (
        <div className="fixed bottom-4 right-4 md:bottom-8 md:right-8 z-50 animate-slide-up-fade">
            <div className="bg-gradient-to-r from-amber-500 to-yellow-600 text-black p-0.5 rounded-2xl shadow-2xl shadow-amber-600/20 max-w-sm">
                <div className="bg-white dark:bg-slate-900 rounded-[14px] p-4 flex items-start gap-3 relative overflow-hidden">
                    ...
                    <div className="bg-amber-200 dark:bg-amber-900/30 p-2 rounded-xl text-amber-800 dark:text-amber-400 shrink-0">
                        <Sparkles size={20} className="animate-pulse" />
                    </div>

                    <div className="flex-1 pr-6">
                        <p className="text-xs font-bold text-amber-800 dark:text-amber-400 uppercase tracking-wider mb-0.5">
                            Smart Offer Found!
                        </p>
                    ...
                    <div className="absolute bottom-0 left-0 h-0.5 bg-amber-500 w-full animate-shrink-width"></div>
                </div>
            </div>
        </div>
    );
