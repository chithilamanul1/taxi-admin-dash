...
const SmartOfferNudge = ({ offer, onClose }) => {
    ...
    return (
        <div className="fixed bottom-6 right-6 md:bottom-10 md:right-10 z-[1000] max-w-[calc(100vw-48px)] w-96 group/nudge">
            <motion.div 
            ...
            >
                ...
                {/* Icon Section */}
                <div className="w-14 h-14 bg-emerald-600 rounded-2xl flex items-center justify-center shrink-0 shadow-lg shadow-emerald-200 dark:shadow-none animate-bounce-slow">
                ...
                <div className="relative z-10 flex-1">
                    <div className="flex items-center gap-2 mb-1">
                        <span className="text-[10px] font-black text-emerald-600 uppercase tracking-widest bg-emerald-50 dark:bg-emerald-500/10 px-2 py-0.5 rounded-full">Active Offer</span>
                    </div>
                    
                    <h4 className="font-black text-emerald-950 dark:text-white leading-tight mb-1 text-xl tracking-tight">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="px-4 py-2 bg-emerald-600 rounded-xl shadow-md">
                            <span className="text-xs font-black text-white uppercase tracking-wider">
                                {offer.discountPercentage > 0 ? `${offer.discountPercentage}% OFF` : `Save Rs. ${offer.discountAmount}`}
                            </span>
                        </div>
                        <div className="flex flex-col">
                            <span className="text-[9px] font-black text-emerald-950 dark:text-white uppercase tracking-widest leading-none mb-1">Verified Code</span>
