                    ...
                    <div className="px-4 py-8 bg-slate-50 border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,0.05)] mb-12">
                        <div className="flex justify-between relative">
                            ...
                            {[
                                ...
                                { id: 'confirmed', alternateId: 'assigned', label: 'Assigned', icon: UserIcon },
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center gap-4 border-b-4 border-slate-50 pb-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-black text-black text-lg italic tracking-tighter leading-none">{booking.scheduledDate ? new Date(booking.scheduledDate).toLocaleDateString() : 'TBD'}</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4 border-b-4 border-slate-50 pb-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-black text-black text-lg italic tracking-tighter leading-none">{booking.scheduledTime || 'TBD'}</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4 border-b-4 border-slate-50 pb-4">
