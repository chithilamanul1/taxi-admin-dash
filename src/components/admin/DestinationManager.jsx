                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-6">
                    ...
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                        ...
                        <button
                            ...
                            className="bg-amber-600 hover:bg-amber-700 text-white px-4 py-2.5 rounded-xl text-sm font-bold flex items-center justify-center gap-2 transition-all shadow-lg shadow-amber-500/20 active:scale-95"
                        >
                        ...
                        >
                            ...
                            <form onSubmit={handleSave} className="flex-1 overflow-y-auto p-5 md:p-8 space-y-6 md:space-y-8">
                                    ...
                                    <div className="md:col-span-2 p-6 bg-slate-50 dark:bg-white/5 rounded-[2.5rem] border border-slate-200 dark:border-white/5 space-y-6">
                                        <div className="flex flex-col gap-4">
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <input type="number" className="w-16 px-2 py-1 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg text-xs" value={form.sortOrder} onChange={e => setForm({ ...form, sortOrder: Number(e.target.value) })} />
                                            </div>
                                        </div>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-white dark:bg-slate-900/50 p-6 rounded-3xl border border-blue-500/20 shadow-inner">
                                            <div className="space-y-4">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <h5 className="text-base font-bold text-slate-900 dark:text-white">{VEHICLE_TYPES.find(v => v.slug === selectedVehicle)?.label} Config</h5>
                                        ...
                                        <div className="md:col-span-2 space-y-4">
                                            <div className="flex items-center justify-between">
                                                ...
                                                <button
                                                    ...
                                                    className="px-3 py-1.5 bg-amber-600 text-white rounded-lg text-xs font-bold flex items-center gap-2"
                                                >
                                ...
                                <div className="flex gap-4 pt-4 border-t border-slate-100 dark:border-white/10">
                                    ...
                                    <button type="submit" className="flex-1 py-4 bg-amber-600 hover:bg-amber-700 text-white rounded-2xl font-bold flex items-center justify-center gap-2 shadow-lg shadow-amber-500/30 transition-all">
                                        <Check size={20} />
                                        Save Changes
                                    </button>
                                </div>
