...
export default function BookingAssignmentModal({ booking, onClose, onAssignSuccess }) {
    ...
    return (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-white dark:bg-emerald-900 w-full max-w-lg rounded-2xl shadow-2xl flex flex-col max-h-[90vh]">
                                ...
                                return (
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p className="font-bold text-emerald-900 dark:text-white text-sm">{driver.name}</p>
                ...
                <div className="px-6 py-4 bg-slate-50 dark:bg-emerald-900/50 border-t dark:border-white/10">
