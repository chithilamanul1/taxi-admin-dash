    ...
    return (
        <div className="pb-32">
            <div className="bg-slate-50 py-24 text-center">
                <h1 className="text-slate-950 text-5xl md:text-6xl font-extrabold mb-4">Our <span className="text-amber-600">Services</span></h1>
            ...
            <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-3 gap-10 -mt-10">
                <div className="bg-white p-10 rounded-3xl shadow-xl relative overflow-hidden group border border-gray-100">
                    <div className="w-16 h-16 bg-amber-600 text-slate-950 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                        <Star />
                    </div>
                    <h3 className="text-2xl font-bold text-slate-950 mb-4">Budget Selection</h3>
                ...
                <div className="bg-slate-950 p-10 rounded-3xl shadow-2xl relative overflow-hidden group transform md:scale-105 z-10">
                    <div className="w-16 h-16 bg-white text-slate-950 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                        <Award />
                    </div>
                    ...
                    <ul className="space-y-3">
                        <li className="flex items-center gap-2 text-sm text-white/70"><CheckCircle2 className="text-amber-600 w-4 h-4" /> Toyota Premio / Allion</li>
                        <li className="flex items-center gap-2 text-sm text-white/70"><CheckCircle2 className="text-amber-600 w-4 h-4" /> 3 Large Suitcases</li>
                    </ul>
                </div>
                <div className="bg-white p-10 rounded-3xl shadow-xl relative overflow-hidden group border border-gray-100">
                    <div className="w-16 h-16 bg-amber-600 text-slate-950 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                    ...
                    <h3 className="text-2xl font-bold text-slate-950 mb-4">Luxury Van</h3>
