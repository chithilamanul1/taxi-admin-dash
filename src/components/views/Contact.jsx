        ...
        <div className="pb-20 dark:bg-slate-950 transition-colors">
            <div className="bg-slate-900 py-24">
                <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center text-white">
                    <div>
                        <h1 className="text-5xl font-extrabold mb-6">Let's Talk <span className="text-slate-600 dark:text-amber-400">Travel</span></h1>
                        ...
                        <div className="space-y-8">
                            <div className="flex gap-4 items-center">
                                <div className="w-12 h-12 bg-slate-600/20 rounded-xl flex items-center justify-center text-slate-600">
                                    <Phone size={24} />
                                </div>
                                <div>
                            ...
                            <div className="flex gap-4 items-center">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-600 dark:text-amber-400 mt-1">Reg No: PV 00342552</p>
                                </div>
                            </div>
                        </div>
                    </div>
