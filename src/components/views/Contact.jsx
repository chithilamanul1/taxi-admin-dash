        ...
        <div className="pb-20 dark:bg-emerald-900 transition-colors">
            <div className="bg-emerald-900 py-24">
                <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center text-white">
                        ...
                        <div className="space-y-8">
                            <div className="flex gap-4 items-center">
                                ...
                                <div>
                                    ...
                                    <p className="text-lg font-bold leading-tight">0722 885 885</p>
                                    <p className="text-lg font-bold leading-tight">0719 885 885</p>
                                    <p className="text-lg font-bold leading-tight">0712 100 500</p>
                                </div>
                            </div>
                            <div className="flex gap-4 items-center">
                                <div className="w-12 h-12 bg-emerald-600/20 rounded-xl flex items-center justify-center text-emerald-600">
                    ...
                    <div className="bg-white dark:bg-emerald-900 p-2 rounded-[2.5rem] shadow-2xl border border-white/5 transition-colors">
                        <BookingForm />
                    </div>
                </div>
            </div>
