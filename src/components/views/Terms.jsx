...
const Terms = () => {
    return (
        <div className="pb-20">
            {/* Header */}
            <div className="bg-slate-900 py-16 md:py-24 text-center px-4">
                <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4">Terms <span className="text-slate-600">& Conditions</span></h1>
            ...
            <div className="max-w-4xl mx-auto px-6 py-12">
                <div className="prose prose-lg prose-slate max-w-none">
                    ...
                    <h3 className="text-slate-900 font-bold mt-8 mb-4">1. Customer Registration</h3>
                    <p>
                    ...
                    <h3 className="text-slate-900 font-bold mt-8 mb-4">2. Booking & Payment</h3>
                    ...
                    <h3 className="text-slate-900 font-bold mt-8 mb-4">3. Service Delivery (Transport / Pickup)</h3>
                    <ul className="list-disc pl-5 space-y-2">
                    ...
                    <h3 className="text-slate-900 font-bold mt-8 mb-4">4. Cancellation & Refunds</h3>
                    ...
                    <h3 className="text-slate-900 font-bold mt-8 mb-4">5. Fraud Prevention & Verification</h3>
                    <ul className="list-disc pl-5 space-y-2">
                    ...
                    <h3 className="text-slate-900 font-bold mt-8 mb-4">6. Communication & Records</h3>
                    <p>
                    ...
                    <h3 className="text-slate-900 font-bold mt-8 mb-4">7. Policy Display & Payment Links</h3>
                    <p>
                    ...
                    <h3 className="text-slate-900 font-bold mt-8 mb-4">8. Overseas & Special Transactions</h3>
                    <ul className="list-disc pl-5 space-y-2">
                    ...
                    <h3 className="text-slate-900 font-bold mt-8 mb-4">9. Legal Compliance</h3>
                    <p>
                    ...
                    <h3 className="text-slate-900 font-bold mt-8 mb-4">10. Limitation of Liability</h3>
                    <p>
                    ...
                    <h3 className="text-slate-900 font-bold mt-8 mb-4">11. Privacy Policy</h3>
                    <p>
                    ...
                    <h3 className="text-slate-900 font-bold mt-8 mb-4">12. Contact</h3>
                    <div className="bg-slate-50 p-6 rounded-xl border border-gray-100">
                        <p className="font-bold text-slate-900">AIRPORT TAXIS (PVT) LTD</p>
                    ...
                    <h3 className="text-slate-900 font-bold mt-8 mb-4">13. Agreement</h3>
                    <p>
