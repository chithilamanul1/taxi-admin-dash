    ...
    return (
        <div className="pb-20">
            ...
            <div className="bg-slate-950 py-16 md:py-24 text-center px-4">
                <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4">Day <span className="text-amber-600">Trips</span></h1>
                    ...
                    {DAY_TRIPS.map((trip, idx) => (
                        <div key={idx} itemScope itemType="https://schema.org/Product" className="bg-white rounded-2xl shadow-xl overflow-hidden group hover:shadow-2xl transition-all duration-300 flex flex-col">
                            ...
                            <div className="h-56 overflow-hidden relative">
                                ...
                                />
                                {trip.tags.map((tag, i) => (
                                    <div key={i} className={`absolute top-3 ${i === 0 ? 'left-3' : 'right-3'} bg-slate-950/90 text-white text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-wider backdrop-blur-sm`}>
                                        {tag}
                                    </div>
                                ))}
                            </div>
                            ...
                            <div className="p-6 flex flex-col flex-1">
                                ...
                                <h3 itemProp="name" className="text-xl font-bold text-slate-950 mb-2 line-clamp-2" title={trip.title}>{trip.title}</h3>
                                ...
                                <div className="mt-auto pt-6 border-t border-gray-100 flex items-end justify-between">
                                    <div itemProp="offers" itemScope itemType="https://schema.org/Offer">
                                        ...
                                        <div className="text-3xl font-extrabold text-amber-600 leading-none">
                                    ...
                                    <button
                                        ...
                                        className="bg-slate-950 text-white p-3 rounded-xl hover:bg-amber-600 hover:text-slate-950 transition-all shadow-lg hover:checkbox-md"
                                    >
                                        <ArrowRight size={24} />
                                    </button>
                                </div>
            ...
            <div className="text-center mt-16">
                ...
                <Link href="/contact" className="inline-block bg-amber-600 text-slate-950 font-bold px-8 py-3 rounded-xl hover:scale-105 transition-transform">
