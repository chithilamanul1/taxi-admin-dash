    ...
    return (
        <div className="pb-20 dark:bg-slate-950 transition-colors">
            ...
            <div className="bg-slate-900 py-20 text-center text-white px-4">
                <h1 className="text-4xl md:text-5xl font-extrabold mb-4">About <span className="text-slate-600 dark:text-amber-400">Airport Taxis Pvt (Ltd)</span></h1>
            ...
            <div className="max-w-7xl mx-auto px-6 py-12">
                <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
                    ...
                    <div className="space-y-6">
                        <div>
                            <span className="text-slate-600 dark:text-amber-400 font-bold tracking-widest uppercase text-sm">Who We Are</span>
                            <h2 className="text-3xl font-bold text-slate-900 dark:text-white mt-2">More than just a Taxi Service</h2>
                        </div>
                        ...
                        <div className="grid grid-cols-3 gap-6 pt-6 border-t border-gray-100 dark:border-white/5">
                            <div>
                                <h3 className="font-bold text-3xl text-slate-600 dark:text-amber-400">5k+</h3>
                                <p className="text-xs text-gray-400 dark:text-slate-500 font-bold uppercase">Happy Clients</p>
                            </div>
                            <div>
                                <h3 className="font-bold text-3xl text-slate-600 dark:text-amber-400">500+</h3>
                                <p className="text-xs text-gray-400 dark:text-slate-500 font-bold uppercase">Tours Completed</p>
                            </div>
                            <div>
                                <h3 className="font-bold text-3xl text-slate-600 dark:text-amber-400">24/7</h3>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    <div className="bg-slate-50 dark:bg-slate-900 p-8 rounded-3xl border border-slate-100 dark:border-white/5 hover:shadow-xl transition-all hover:-translate-y-1">
                        <div className="w-12 h-12 bg-slate-900 dark:bg-white/5 text-slate-600 dark:text-amber-400 rounded-full flex items-center justify-center mb-4 text-2xl border border-white/5">
                            <Shield size={24} />
                        </div>
                        <h3 className="font-bold text-lg text-slate-900 dark:text-white mb-2">Safety First</h3>
                    ...
                    <div className="bg-slate-50 dark:bg-slate-900 p-8 rounded-3xl border border-slate-100 dark:border-white/5 hover:shadow-xl transition-all hover:-translate-y-1">
                        ...
                        <h3 className="font-bold text-lg text-slate-900 dark:text-white mb-2">Punctual Service</h3>
                    ...
                    <div className="bg-slate-50 dark:bg-slate-900 p-8 rounded-3xl border border-slate-100 dark:border-white/5 hover:shadow-xl transition-all hover:-translate-y-1">
                        ...
                        <h3 className="font-bold text-lg text-slate-900 dark:text-white mb-2">Best Price Guarantee</h3>
