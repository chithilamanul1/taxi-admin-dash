...
export default function AdminTourManager() {
            ...
            <div className="bg-white dark:bg-slate-900 rounded-xl shadow-lg p-6 border border-white/10">
                <div className="flex justify-between items-center mb-6">
                    ...
                    <div className="flex gap-2">
                        ...
                        <button onClick={handleSave} className="px-6 py-2 rounded-lg bg-amber-600 text-white font-bold hover:bg-amber-700 shadow-lg">Save Tour</button>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-slate-50 dark:bg-white/5 p-4 rounded-xl border border-slate-100 dark:border-white/10">
                            ...
                            <div className="flex gap-2">
                                <span className="bg-amber-100 text-amber-800 px-3 py-2 rounded font-bold text-sm flex items-center">{formData.price?.currency || 'USD'}</span>
                                <input
                                    type="number"
    ...
    return (
        <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm p-8 border border-white/5">
            <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold text-slate-950 dark:text-white">Tour Management</h2>
                <button
                    onClick={handleCreateNew}
                    className="flex items-center gap-2 bg-amber-600 text-white px-5 py-2.5 rounded-xl font-bold hover:bg-amber-700 transition-all shadow-lg shadow-amber-600/20"
                >
                    ...
                    {tours.map(tour => (
                        <div key={tour._id} className="bg-white dark:bg-slate-800 p-4 rounded-xl border border-slate-100 dark:border-white/5 flex items-center gap-4 hover:shadow-md transition-shadow group">
                            ...
                            <div className="flex-1">
                                ...
                                <h3 className="font-bold text-slate-950 dark:text-white text-lg">{tour.title}</h3>
