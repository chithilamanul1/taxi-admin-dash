...
const AdminDashboard = () => {
    ...
    return (
        <div className="flex h-screen bg-slate-100 dark:bg-emerald-900 transition-colors">
            {/* Sidebar */}
            <div className={`${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 fixed md:static inset-y-0 left-0 z-50 bg-emerald-900 dark:bg-emerald-900 text-white transition-all duration-300 ${sidebarOpen && 'md:w-64'} ${!sidebarOpen && 'md:w-20'} w-64 flex flex-col`}>
    ...
    return (
        <div className="flex flex-1 gap-6 overflow-hidden">
            ...
            <div className="flex-1 bg-slate-50 dark:bg-white/5 rounded-xl border dark:border-white/10 flex flex-col overflow-hidden">
                {activeTicket ? (
                    <>
                        <div className="p-4 border-b dark:border-white/10 bg-white dark:bg-emerald-900">
                        ...
                        <div className="p-4 bg-white dark:bg-emerald-900 border-t dark:border-white/10">
