...
const TrackingMap = ({ pickup, dropoff, driverId }) => {
    ...
    return (
        <div className="space-y-4">
            <div className="w-full h-[400px] rounded-none overflow-hidden border-4 border-black relative">
                <GoogleMap
                ...
                <div className="absolute top-4 left-4 flex flex-col gap-2">
                    {driverId && (
                        <div className="bg-black text-[#FACC15] px-4 py-2 border-2 border-[#FACC15] text-[10px] font-black uppercase tracking-widest flex items-center gap-2">
                ...
                {!driverId && (
                    <div className="absolute bottom-4 left-4 right-4 bg-white/90 dark:bg-black/90 p-3 rounded-none border-4 border-black text-[10px] text-center font-black uppercase tracking-widest text-black dark:text-[#FACC15]">
            ...
            {driverData && (
                <div className="bg-[#FACC15] border-4 border-black p-4 rounded-none flex items-center justify-between animate-fade-in">
                    <div className="flex items-center gap-4">
                        <div className="w-12 h-12 bg-black rounded-none border-2 border-black flex items-center justify-center text-[#FACC15] font-black text-xl">
                    ...
                    <div className="flex flex-col items-end">
                        <span className="bg-black text-[#FACC15] text-[10px] uppercase font-black px-3 py-1.5 border-2 border-black rounded-none">Active Now</span>
                    </div>
                </div>
            )}
        </div>
