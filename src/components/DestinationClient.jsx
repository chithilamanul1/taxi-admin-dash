            ...
            <div className="max-w-7xl mx-auto px-6 -mt-20 relative z-10">
                <div className="grid lg:grid-cols-3 gap-10">
                    ...
                    <div className="lg:col-span-2 space-y-10">
                        {/* Overview Card */}
                        <div className="bg-white dark:bg-slate-900 rounded-3xl p-8 md:p-12 shadow-xl border border-slate-950/5 dark:border-white/5">
                            <div className="flex items-center gap-3 mb-8">
                                <div className="w-12 h-12 bg-amber-100 dark:bg-slate-950/30 rounded-2xl flex items-center justify-center text-amber-600 dark:text-amber-400">
                                    <Info size={24} />
                                </div>
                                <h2 className="text-3xl font-black text-slate-950 dark:text-white">Experience {destination.name}</h2>
                            </div>
                            ...
                            <div className="mt-12 pt-12 border-t border-gray-100 dark:border-gray-800">
                                <h3 className="font-bold text-slate-950 dark:text-white mb-8 uppercase text-sm tracking-widest">Journey Highlights</h3>
                                <div className="grid sm:grid-cols-2 gap-4">
                                    {destination.highlights && destination.highlights.map((item, i) => (
                                        <div key={i} className="flex items-center gap-4 bg-amber-50 dark:bg-slate-950/20 p-5 rounded-2xl border border-amber-100/50 dark:border-amber-500/10">
                                            ...
                                            <span className="font-bold text-slate-950 dark:text-amber-100 tracking-tight">{item}</span>
                                        </div>
                                    ))}
                                </div>
                            </div>
                        ...
                        <div className="bg-white dark:bg-slate-900 rounded-3xl overflow-hidden shadow-xl border border-slate-950/5 dark:border-white/5">
                            <div className="p-8 md:p-10 border-b border-gray-100 dark:border-gray-800 flex flex-col md:flex-row md:items-center justify-between gap-4">
                                <div>
                                    <h2 className="text-2xl font-black text-slate-950 dark:text-white">Fixed Rates from Airport</h2>
                                ...
                                {destination.pricing && Object.entries(destination.pricing).map(([vehicle, price]) => (
                                    <div key={vehicle} className="p-8 flex items-center justify-between hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group">
                                        <div className="flex items-center gap-6">
                                            <div className="w-14 h-14 bg-slate-100 dark:bg-slate-800 rounded-2xl flex items-center justify-center text-slate-500 group-hover:bg-amber-100 dark:group-hover:bg-slate-950/30 group-hover:text-amber-600 transition-colors">
                                                <Car size={32} />
                                            </div>
                                            <div>
                                                <h3 className="font-black text-xl text-slate-950 dark:text-white">{vehicle}</h3>
                        ...
                        {destination.faqs && destination.faqs.length > 0 && (
                            <div className="bg-white dark:bg-slate-900 rounded-3xl p-8 md:p-12 shadow-xl border border-slate-950/5 dark:border-white/5">
                                <div className="flex items-center gap-3 mb-10">
                                    ...
                                    <h2 className="text-3xl font-black text-slate-950 dark:text-white">Route FAQs</h2>
                                </div>
                                <div className="space-y-4">
                                    {destination.faqs.map((faq, i) => (
                                        <div key={i} className="border border-gray-100 dark:border-gray-800 rounded-2xl overflow-hidden">
                                            ...
                                            >
                                                <span className="font-black text-slate-950 dark:text-white text-lg tracking-tight">{faq.q}</span>
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-slate-950 rounded-[2.5rem] p-10 text-white shadow-2xl sticky top-24 border border-amber-700/50 overflow-hidden group">
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="space-y-6 mb-10">
                                    <div className="flex justify-between items-center py-4 border-b border-amber-800/50">
                                ...
                                <button
                                    ...
                                    className="w-full py-6 bg-white text-slate-950 rounded-[1.5rem] font-black text-xl hover:bg-amber-50 transition-all transform hover:scale-[1.02] active:scale-[0.98] shadow-2xl flex items-center justify-center gap-3 group/btn"
                                >
