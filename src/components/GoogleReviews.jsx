...
const GoogleReviews = () => {
    ...
    return (
        <section className="py-24 bg-emerald-900 overflow-hidden relative border-t border-slate-800">
                ...
                <div className="flex flex-col md:flex-row items-end justify-between mb-12 gap-6">
                    <div className="max-w-2xl">
                        <div className="flex items-center gap-2 mb-4">
                            <span className="bg-emerald-400 text-emerald-900 text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-widest">Testimonials</span>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button onClick={() => scroll('right')} className="w-12 h-12 rounded-full bg-white text-emerald-900 hover:bg-emerald-500 hover:text-white flex items-center justify-center transition-all group shadow-lg shadow-white/5">
                ...
                <div className="flex flex-wrap items-center gap-4 mb-12">
                    <button
                        ...
                        className={`flex items-center gap-3 px-6 py-3 rounded-2xl border transition-all ${activeSource === 'google'
                            ? 'bg-white border-white text-emerald-900 shadow-xl shadow-white/5'
                    ...
                    {reviews.length > 0 ? reviews.map((review, idx) => (
                        ...
                        >
                            ...
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <div>
                                    <h4 className="font-bold text-emerald-900 text-sm">{review.author_name}</h4>
