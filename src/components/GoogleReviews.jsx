...
const GoogleReviews = () => {
    ...
    return (
        <section className="py-24 bg-slate-900 overflow-hidden relative border-t border-slate-800">
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-slate-900/10 rounded-full blur-[100px] pointer-events-none"></div>
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                >
                    {reviews.length > 0 ? reviews.map((review, idx) => (
                        ...
                        >
                            <Quote size={40} className="absolute top-6 right-6 text-slate-100 group-hover:text-amber-200 transition-colors" />

                            <div className="flex items-center gap-3 mb-6">
                                <div className="relative">
                                    <div className="w-12 h-12 rounded-full overflow-hidden bg-slate-100 flex items-center justify-center text-slate-700 font-bold text-lg border-2 border-slate-50">
