            ...
            <div className="container mx-auto px-4 relative z-10 max-w-7xl">
                <div className="flex flex-col md:flex-row items-end justify-between mb-8 gap-4">
                    <div className="max-w-2xl">
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-emerald-950 dark:text-white leading-tight tracking-tight mb-4">
                ...
                <div className="flex flex-row flex-wrap items-center gap-2 md:gap-4 mb-8">
                    <button
                        ...
                        className={`group flex items-center gap-3 p-2 pr-4 border-2 transition-all rounded-2xl border-black ${activeSource === 'google'
                    ...
                    >
                        <div className="w-8 h-8 shrink-0 bg-white dark:bg-zinc-800 rounded-xl flex items-center justify-center p-1.5 shadow-sm border border-slate-100 dark:border-white/5">
                        ...
                        <div className="text-left flex flex-col md:flex-row md:items-center md:gap-2">
                            <div className="font-bold uppercase tracking-widest text-[10px]">Google Reviews</div>
                            <div className="text-[9px] font-bold opacity-70 mt-0.5 md:mt-0">{stats.google.rating} / 5.0 • {stats.google.total}+ Reviews</div>
                        </div>
                    </button>

                    <button
                        onClick={() => setActiveSource('tripadvisor')}
                        className={`group flex items-center gap-3 p-2 pr-4 border-2 transition-all rounded-2xl border-black ${activeSource === 'tripadvisor'
                            ? 'bg-emerald-50 dark:bg-emerald-900/20 text-emerald-900 dark:text-emerald-400 shadow-sm'
                            : 'bg-white dark:bg-zinc-900 text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-zinc-800'
                            }`}
                    >
                        <div className="w-8 h-8 shrink-0 flex items-center justify-center bg-white dark:bg-zinc-800 border border-slate-100 dark:border-white/5 p-1.5 text-[#00AA6C] rounded-xl shadow-sm">
                        ...
                        <div className="text-left flex flex-col md:flex-row md:items-center md:gap-2">
                            <div className="font-bold uppercase tracking-widest text-[10px]">TripAdvisor</div>
                            <div className="text-[9px] font-bold opacity-70 mt-0.5 md:mt-0">{stats.tripadvisor.rating} / 5.0 • {stats.tripadvisor.total}+ Reviews</div>
                        </div>
                    </button>
                </div>
