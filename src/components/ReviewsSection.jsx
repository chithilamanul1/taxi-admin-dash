...
export default function ReviewsSection() {
    ...
    if (loading) {
        return (
            <section className="py-20 bg-gradient-to-b from-slate-50 to-white dark:from-emerald-900 dark:to-emerald-900">
    ...
    return (
        <section className="py-20 bg-gradient-to-b from-slate-50 to-white dark:from-emerald-900 dark:to-emerald-900 overflow-hidden">
            <div className="container mx-auto px-6">
                {/* Header */}
                <div className="text-center mb-12">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 text-xs font-bold uppercase tracking-widest mb-4">
                        <Star size={14} className="fill-current" />
                        Customer Reviews
                    </div>
                    <h2 className="text-3xl md:text-4xl font-black text-emerald-900 dark:text-white mb-4">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <div className="flex items-center gap-2">
                                    <h4 className="font-bold text-emerald-900 dark:text-white">{currentReview.userName}</h4>
