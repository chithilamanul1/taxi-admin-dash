            ...
            <div className="container mx-auto px-6">
                ...
                <div className="text-center mb-12">
                    ...
                    <h2 className="text-3xl md:text-4xl font-black text-slate-900 dark:text-white mb-4">
                        What Our <span className="text-slate-600 dark:text-amber-400">Travelers</span> Say
                    </h2>
                ...
                <div className="max-w-4xl mx-auto relative">
                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-xl p-8 md:p-12 relative">
                        {/* Quote Icon */}
                        <div className="absolute top-6 right-6 text-slate-100 dark:text-slate-900/50">
                            <Quote size={60} />
                        </div>
                        ...
                        {currentReview.route && (
                            <div className="flex flex-wrap gap-3 mb-6">
                                <span className="inline-flex items-center gap-2 px-4 py-2 bg-slate-50 dark:bg-slate-900/30 text-slate-700 dark:text-amber-400 rounded-full text-sm font-medium">
                                    <MapPin size={14} />
                                    {currentReview.route}
                                </span>
                        ...
                        <div className="flex items-center gap-4">
                            {/* Avatar */}
                            <div className="w-14 h-14 rounded-full bg-slate-100 dark:bg-slate-900/30 flex items-center justify-center overflow-hidden">
                                {currentReview.userImage ? (
                                    ...
                                    <span className="text-2xl font-bold text-slate-600 dark:text-amber-400">
                            ...
                            <div>
                                <div className="flex items-center gap-2">
                                    ...
                                    {currentReview.isVerified && (
                                        <span className="inline-flex items-center gap-1 text-xs text-slate-600 dark:text-amber-400 bg-slate-50 dark:bg-slate-900/30 px-2 py-1 rounded-full">
                ...
                <div className="max-w-3xl mx-auto mt-16 grid grid-cols-3 gap-8 text-center">
                    <div>
                        <div className="text-4xl font-black text-slate-600 dark:text-amber-400 mb-2">500+</div>
                        <div className="text-slate-600 dark:text-slate-400 text-sm">Happy Customers</div>
                    </div>
                    <div>
                        <div className="text-4xl font-black text-slate-600 dark:text-amber-400 mb-2">5.0</div>
                        <div className="text-slate-600 dark:text-slate-400 text-sm">Average Rating</div>
                    </div>
                    <div>
                        <div className="text-4xl font-black text-slate-600 dark:text-amber-400 mb-2">98%</div>
