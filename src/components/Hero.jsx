...
const Hero = ({ onBookClick }) => {
    ...
    return (
        <section className="relative h-[85vh] md:h-[90vh] min-h-[600px] flex items-center justify-center pt-36 md:pt-32 pb-20 md:pb-40 overflow-hidden bg-emerald-950 transition-colors">
            ...
            {/* Content */}
            <div className="container mx-auto px-6 relative z-10 text-left lg:text-left mt-12 md:mt-[-5vh]">
