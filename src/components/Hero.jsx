...
const Hero = ({ onBookClick }) => {
    ...
    return (
        <section className="relative h-[85vh] md:h-[90vh] min-h-[600px] flex items-center justify-center pt-24 md:pt-32 pb-20 md:pb-40 overflow-hidden bg-emerald-950 transition-colors">
