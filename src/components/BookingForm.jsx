...
${boardInfo}
    ...
    return (
        <form onSubmit={handleSubmit} className="p-10 rounded-[2.5rem] border border-slate-950/10 shadow-2xl bg-white text-slate-950 max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="space-y-2">
                    ...
                    <input
                        ...
                        className="w-full bg-slate-50 border-none px-6 py-4 rounded-xl focus:ring-2 focus:ring-slate-950/20 outline-none transition-all"
                    />
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                    ...
                    <input
                        ...
                        placeholder="EK 650"
                        className="w-full bg-slate-50 border-none px-6 py-4 rounded-xl focus:ring-2 focus:ring-slate-950/20 outline-none transition-all uppercase"
                    />
                </div>
                ...
                <div className="space-y-2 md:col-span-2">
                    ...
                    <DatePicker
                        ...
                        className="w-full bg-slate-50 border-none px-6 py-4 rounded-xl focus:ring-2 focus:ring-slate-950/20 outline-none transition-all cursor-pointer"
            ...
            <div className="mt-8 p-6 bg-slate-50 rounded-2xl border border-slate-100">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <div className="flex items-center gap-3">
                                <Signpost size={20} className={formData.boardShow ? 'text-amber-600' : 'text-slate-400'} />
                    ...
                    <div className="text-right">
                        <span className="font-bold text-slate-950 uppercase">NAME BOARD</span>
                        <span className="block font-bold text-amber-600 text-sm">+ Rs 2000.00</span>
                ...
                {formData.boardShow && (
                    <div className="mt-4 animate-fade-in">
                        ...
                        <input
                            ...
                            className="w-full bg-white border border-gray-200 px-4 py-3 rounded-xl focus:ring-2 focus:ring-slate-950/20 outline-none text-sm"
                        />
                    </div>
                )}
            </div>
            ...
            <div className="mt-8 space-y-2">
                ...
                <textarea
                    ...
                    className="w-full bg-slate-50 border-none px-6 py-4 rounded-xl focus:ring-2 focus:ring-slate-950/20 outline-none transition-all resize-none"
                ></textarea>
            </div>
            ...
            <button
                ...
                className="mt-10 w-full bg-slate-950 text-white font-extrabold text-xl py-5 rounded-2xl shadow-xl hover:bg-amber-800 hover:scale-[1.01] transition-all disabled:opacity-70 disabled:grayscale"
            >
