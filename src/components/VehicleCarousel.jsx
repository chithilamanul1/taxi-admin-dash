        ...
        <div className="relative group/carousel">
            <div className="flex justify-between items-center mb-4 px-2">
                ...
                <div className="flex gap-2">
                    <button
                        onClick={() => scroll('left')}
                        className="p-2 rounded-full border border-slate-900/10 hover:bg-slate-50 text-slate-900 transition-colors"
                    ...
                    return (
                        <div
                            ...
                            className={`
                                ...
                                ${isSelected ? 'border-slate-600 bg-slate-600/5 shadow-xl ring-2 ring-slate-600/20' : 'border-slate-100 dark:border-white/10 bg-white dark:bg-white/[0.03] shadow-sm hover:border-amber-200 dark:hover:border-amber-500/30'}
                        ...
                        >
                            ...
                            <div className="h-40 w-full p-4 bg-slate-50/50 rounded-t-2xl relative flex items-center justify-center">
                                ...
                                <button
                                    ...
                                    className="absolute top-3 right-3 p-1.5 bg-white rounded-full shadow-sm text-slate-900/40 hover:text-slate-600 hover:scale-110 transition-all z-20"
                            ...
                            <div className="p-5">
                                <div className="flex justify-between items-start mb-4 h-12">
                                    <h4 className="font-black text-slate-900 dark:text-white uppercase text-sm tracking-wide leading-tight">
                                    ...
                                    {suitable && <div className={`shrink-0 w-5 h-5 rounded-full border-2 flex items-center justify-center ${isSelected ? 'border-slate-600 bg-slate-600' : 'border-slate-300 dark:border-slate-600'}`}>
                                ...
                                <div className="flex justify-between items-end border-t border-slate-100 dark:border-slate-700 pt-3">
                                    <div>
                                        ...
                                        <p className="text-lg font-black text-slate-900 dark:text-amber-400">LKR {vehicle.perKmRate}</p>
                                    </div>
                                    <div className={`
                                        text-[10px] font-bold px-3 py-1.5 rounded-lg uppercase tracking-wider
                                        ${isSelected ? 'bg-slate-600 text-white' : 'bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400'}
                                    `}>
