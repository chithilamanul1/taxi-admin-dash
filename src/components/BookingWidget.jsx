...
const FALLBACK_PRICING = {
    ...
    'sedan': { vehicleType: 'sedan', name: 'SEDAN', image: '/vehicles/sedancar.png', capacity: 4, luggage: 3, handLuggage: 3, basePrice: 4500, baseKm: 20, perKmRate: 130, tiers: [{ min: 0, max: 20, type: 'flat', price: 4500 }, { min: 21, max: 40, type: 'flat', price: 6000 }, { min: 41, max: 50, type: 'per_km', rate: 150 }, { min: 51, max: 100, type: 'per_km', rate: 130 }, { min: 101, max: 140, type: 'per_km', rate: 130 }, { min: 141, max: 200, type: 'per_km', rate: 127 }, { min: 201, max: 9999, type: 'per_km', rate: 122 }] },
    'vezel': { vehicleType: 'vezel', name: 'HONDA VEZEL', image: '/vehicles/Hondavezel.png', capacity: 4, luggage: 3, handLuggage: 3, basePrice: 5500, baseKm: 20, perKmRate: 130, tiers: [{ min: 0, max: 20, type: 'flat', price: 6500 }, { min: 21, max: 40, type: 'flat', price: 9500 }, { min: 41, max: 100, type: 'per_km', rate: 150 }, { min: 101, max: 140, type: 'per_km', rate: 145 }, { min: 141, max: 200, type: 'per_km', rate: 140 }, { min: 201, max: 9999, type: 'per_km', rate: 135 }] },
    'suv': { vehicleType: 'suv', name: 'SUV', image: '/vehicles/suv.png', capacity: 4, luggage: 3, handLuggage: 3, basePrice: 8000, baseKm: 20, perKmRate: 160, tiers: [] },
    'mini-van-every': { vehicleType: 'mini-van-every', name: 'MINI VAN EVERY', image: '/vehicles/susukievery.png', capacity: 5, luggage: 4, handLuggage: 3, basePrice: 4500, baseKm: 20, perKmRate: 150, tiers: [{ min: 0, max: 20, type: 'flat', price: 4500 }, { min: 21, max: 40, type: 'flat', price: 6000 }, { min: 41, max: 50, type: 'per_km', rate: 150 }, { min: 51, max: 100, type: 'per_km', rate: 130 }, { min: 101, max: 140, type: 'per_km', rate: 129 }, { min: 141, max: 200, type: 'per_km', rate: 127 }, { min: 201, max: 9999, type: 'per_km', rate: 122 }] },
...
const BookingWidgetContent = ({ defaultTab = 'pickup', onTabChange, targetLocation = '' }) => {
    ...
    useEffect(() => {
        ...
        // Use ?? (nullish coalescing) not || for luggage so vehicles with luggage:0 in DB
        // don't incorrectly block selection when no luggage is selected
        const bestFit = sortedVehicles.find(v =>
            totalPax <= (v.capacity ?? 4) && totalLuggage <= (v.luggage ?? 4)
        );
    ...
    return (
        <div id="booking" className="w-full max-w-6xl mx-auto pt-6 md:pt-8 pb-8 md:pb-0 relative z-40 px-0 md:px-4">
