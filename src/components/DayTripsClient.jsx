        ...
        <main className="min-h-screen bg-white pt-32 pb-20 text-emerald-900">
            <div className="container mx-auto px-6">
                <div className="text-center mb-12">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-50 border border-emerald-100 text-emerald-900 text-xs font-black uppercase tracking-widest mb-6 shadow-sm">
                        <MapPin size={14} className="text-emerald-500" />
                        Explore Sri Lanka
                    </div>
                    <h1 className="text-4xl md:text-6xl font-black text-emerald-900 mb-4">
                        Day <span className="text-emerald-500">Trips</span>
                    </h1>
                        ...
                        <div className="flex flex-col md:flex-row gap-6">
                            <div className="flex-1 relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-14 pr-6 py-4 bg-white border border-slate-200 rounded-2xl text-emerald-900 placeholder:text-slate-300 focus:outline-none focus:border-emerald-400 focus:ring-4 focus:ring-emerald-50 transition-all"
                                />
                            </div>
                ...
                {loading ? (
                    ...
                    <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mb-12">
                        {filteredTrips.map((trip) => (
                            <div key={trip.slug || trip._id || trip.id} className="bg-white rounded-[2.5rem] overflow-hidden shadow-2xl shadow-slate-200/50 hover:shadow-emerald-200/50 transition-all duration-500 hover:-translate-y-2 group flex flex-col h-full border border-slate-100">
                                {/* Image Section */}
                                <div className="relative h-72 overflow-hidden shrink-0">
                                    ...
                                    <div className="absolute bottom-6 left-6">
                                        <span className="px-4 py-2 bg-emerald-500/90 backdrop-blur text-white text-[10px] font-black uppercase tracking-widest rounded-xl shadow-lg border border-white/20">
                                    ...
                                    <div className="flex items-center justify-between mt-auto pt-8 border-t border-slate-50">
                                        <div>
                                            ...
                                            <div className="flex items-baseline gap-1">
                                                <span className="text-xs font-black text-emerald-500 uppercase">{trip.price?.currency || 'USD'}</span>
                ...
                {filteredTrips.length === 0 && !loading && (
                    <div className="text-center py-32 bg-slate-50 rounded-[3rem] border border-dashed border-slate-200">
                        ...
                        <button
                            ...
                            className="px-10 py-4 bg-emerald-500 text-white rounded-2xl font-black uppercase tracking-widest text-xs shadow-xl shadow-emerald-200 hover:bg-emerald-600 transition-all"
                        >
                            Clear Filters
                        </button>
                    </div>
                    ...
                    <div className="bg-emerald-900 rounded-[3rem] p-10 md:p-16 relative overflow-hidden shadow-2xl shadow-slate-400/20">
                        ...
                        <div className="relative z-10">
                            <h2 className="text-3xl md:text-5xl font-black text-white mb-6 leading-tight">
                                Custom <span className="text-emerald-500">Adventures</span>
                            </h2>
