    ...
    return (
        <section className="py-24 px-6 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto">
                <div className="relative rounded-[3rem] overflow-hidden bg-emerald-900 shadow-2xl border border-white/10">
                    {/* Animated Overlay */}
                    <div className="absolute inset-0 bg-gradient-to-br from-emerald-900/40 via-transparent to-orange-950/20 opacity-50"></div>
                    ...
                    <div className="relative z-10 p-8 md:p-16 lg:p-24 flex flex-col lg:flex-row items-center gap-16">
                        ...
                        <div className="flex-1 text-center lg:text-left">
                            ...
                            <h2 className="text-4xl md:text-6xl font-black text-white mb-8 leading-tight">
                                ...
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-orange-400">In Your Pocket.</span>
                            </h2>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 mt-8 justify-center lg:justify-start">
                                <button className="flex items-center justify-center gap-3 bg-white text-emerald-900 px-6 py-3.5 rounded-2xl hover:bg-slate-100 transition-transform hover:scale-105 shadow-xl group border border-transparent">
                                ...
                                <button className="flex items-center justify-center gap-3 bg-emerald-900 text-white px-6 py-3.5 rounded-2xl border-2 border-slate-700 hover:border-emerald-500 hover:bg-slate-800 transition-all hover:scale-105 shadow-xl group">
                        ...
                        <div className="w-full lg:w-2/5 relative">
                            <div className="relative z-10 w-full aspect-[4/5] rounded-[2.5rem] bg-emerald-900 border border-white/10 p-2 flex items-center justify-center shadow-2xl relative overflow-hidden group">
                                ...
                                <div className="relative w-full h-full rounded-[2rem] overflow-hidden bg-emerald-900">
