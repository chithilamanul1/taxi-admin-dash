        ...
        <section className="py-24 px-6 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto">
                <div className="relative rounded-[3rem] overflow-hidden bg-slate-950 shadow-2xl border border-white/10">
                    {/* Animated Overlay */}
                    <div className="absolute inset-0 bg-gradient-to-br from-amber-900/40 via-transparent to-orange-950/20 opacity-50"></div>

                    <div className="relative z-10 p-8 md:p-16 lg:p-24 flex flex-col lg:flex-row items-center gap-16">
                        {/* Content */}
                        <div className="flex-1 text-center lg:text-left">
                            <div className="inline-flex items-center gap-2 bg-amber-500/10 border border-amber-500/20 backdrop-blur-md rounded-full px-4 py-1.5 mb-8">
                                <Smartphone size={14} className="text-amber-400" />
                                <span className="text-xs font-bold text-amber-400 uppercase tracking-widest">Coming Soon</span>
                            </div>

                            <h2 className="text-4xl md:text-6xl font-black text-white mb-8 leading-tight">
                                Your Premium Journey, <br />
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-400">In Your Pocket.</span>
                            </h2>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 mt-8 justify-center lg:justify-start">
                                ...
                                <button className="flex items-center justify-center gap-3 bg-slate-900 text-white px-6 py-3.5 rounded-2xl border-2 border-slate-700 hover:border-amber-500 hover:bg-slate-800 transition-all hover:scale-105 shadow-xl group">
                                    <FaGooglePlay size={32} className="text-amber-400 group-hover:drop-shadow-[0_0_8px_rgba(251,191,36,0.8)] transition-all" />
                                    <div className="text-left font-sans">
                        ...
                        <div className="w-full lg:w-2/5 relative">
                            <div className="relative z-10 w-full aspect-[4/5] rounded-[2.5rem] bg-slate-900 border border-white/10 p-2 flex items-center justify-center shadow-2xl relative overflow-hidden group">
                                <div className="absolute inset-0 bg-amber-500/5 blur-3xl group-hover:bg-amber-500/10 transition-all"></div>
                                ...
                                <div className="absolute bottom-10 left-10 w-24 h-24 bg-amber-500/5 rounded-full animate-pulse blur-xl"></div>
                            </div>

                            {/* Glowing shadow behind "phone" */}
                            <div className="absolute inset-0 bg-amber-500/20 rounded-full blur-[100px] -z-10 animate-pulse"></div>
                        </div>
                    </div>
                </div>
            </div>
