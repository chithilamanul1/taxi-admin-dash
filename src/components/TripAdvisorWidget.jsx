...
const TripAdvisorWidget = () => {
    ...
    return (
        <div className="bg-white dark:bg-slate-900 py-12 border-t border-slate-900/5 dark:border-white/5">
            <div className="container mx-auto px-6 text-center">
                <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-8">
                    Review us on <span className="text-slate-600">TripAdvisor</span>
                </h3>

                <div className="flex justify-center">
                    <div className={`bg-white p-6 rounded-2xl shadow-sm border border-slate-900/10 inline-block pointer-events-auto transition-opacity duration-500 ${loading ? 'opacity-50' : 'opacity-100'}`}>
