...
const Features = () => {
    return (
        <section className="py-32 bg-black relative overflow-hidden transition-colors border-t border-white/5">
            <div className="container mx-auto px-6 relative z-10">
                <div className="text-center mb-28 animate-slide-up">
                    ...
                    <p className="text-white/40 max-w-2xl mx-auto text-sm font-black uppercase tracking-[0.2em]">
                ...
                <div className="grid md:grid-cols-4 gap-4">
                    {features.map((feature, idx) => (
                        <div
                            key={idx}
                            className="group p-12 bg-white/5 border-l-8 border-[#FACC15] hover:bg-[#FACC15] transition-all duration-500 animate-slide-up"
                        ...
                        >
                            ...
                            <h3 className="text-3xl font-black mb-6 text-white group-hover:text-black transition-colors uppercase italic tracking-tighter leading-none">{feature.title}</h3>
                            <p className="text-white/40 group-hover:text-black/60 text-xs font-black uppercase tracking-widest leading-relaxed transition-colors">
                                {feature.description}
                            </p>
                        </div>
                    ))}
